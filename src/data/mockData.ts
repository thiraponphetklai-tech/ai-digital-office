...
export const MOCK_M365_MIGRATION_PROJECT: Project = {
  ...
  name: 'M365 Migration Project',
  code: 'M365-2026',
  description: 'โครงการย้ายระบบ Microsoft 365: HQ ดำเนินการแล้ว 2,418 จาก 3,388 เครื่อง และ Branch ดำเนินการแล้ว 950 จาก 1,918 สาขา',
  metrics: [
...
export const MOCK_BITLOCKER_PROJECT: Project = {
  ...
  code: 'BLM-2026',
  description: 'ย้ายการเข้ารหัสดิสก์ด้วย BitLocker: Branch 5,912 เครื่องดำเนินการครบ 100% และ HQ 3,733 เครื่อง เหลือ 4 เครื่องกำลังนัดหมาย',
  metrics: [
...
export const MOCK_TASKS: Task[] = [
  ...
  {
    id: 'M365-001', projectId: 'm365-migration-project', title: 'Migration M365 สำหรับ HQ 3,388 เครื่อง',
    description: 'ดำเนินการย้ายระบบสำเร็จ 2,418 เครื่อง (71.37%) เหลือ 970 เครื่อง โดยสถานะยังเป็นไปตามแผน',
    ownerId: 'u4', teamId: 'm365',
    status: 'IN_PROGRESS', priority: 'CRITICAL', progress: 71.37,
    riskLevel: 'LOW', dueDate: '2026-12-31',
    lastUpdatedAt: '2026-08-24T10:00:00+07:00',
  },
  {
    id: 'M365-002', projectId: 'm365-migration-project', title: 'Migration M365 สำหรับ Branch 1,918 สาขา',
    description: 'ดำเนินการแล้ว 950 จาก 1,918 สาขา (49.53%) โดยสถานะยังเป็นไปตามแผน',
    ownerId: 'u2', teamId: 'endpoint',
    status: 'IN_PROGRESS', priority: 'HIGH', progress: 49.53,
    riskLevel: 'LOW', dueDate: '2026-12-31',
    lastUpdatedAt: '2026-08-24T10:00:00+07:00',
  },
  {
  ...
  {
    id: 'BLM-006', projectId: 'bitlocker-migration', title: 'ติดตามอุปกรณ์ HQ คงเหลือ 4 เครื่อง',
    description: 'นัดหมายดำเนินการแล้ว 1 เครื่อง และรอตอบกลับ/ยืนยันนัดหมายอีก 3 เครื่อง เพื่อให้ครบ 3,733 เครื่อง',
