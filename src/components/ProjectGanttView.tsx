...
export function ProjectGanttView() {
  ...
  return <main style={{ flex:1, overflow:'auto', padding:28, background:'var(--color-main-bg)' }}>
    <div style={{ minWidth:1000, maxWidth:1500, margin:'0 auto' }}>
      ...
      <section style={{ border:'1px solid var(--color-main-border)', borderRadius:16, overflow:'hidden', background:'var(--color-main-surface)', boxShadow:'0 2px 8px rgba(31,36,48,.04)' }}>
